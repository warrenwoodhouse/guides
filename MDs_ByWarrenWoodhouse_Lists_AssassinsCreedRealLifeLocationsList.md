...
> '''SCOTCH PLAINS'''
* Scotch Plains: add
* Munroe Tavern (Unmarked): add
* Fort St-Mathieu: add
> '''TROY'S WOOD'''
* Troy's Wood: Troy's Wood, NY.
> '''MONMOUTH'''
* Town of Monmouth: Monmouth, MA.
* Last-Drink Tavern: add
* Fort Monmouth: add
> '''PACKANACK'''
* Add
> '''LEXINGTON'''
...
* North Bridge: add
* The Wright Tavern: add
> '''DIAMOND BASIN'''
* Diamond Basin: add
> '''BLACK CREEK'''
* Black Creek: add
* Fort Duquesne: Fort Duquesne, Philadelphia, PA.
* Ohio River: add
* Mohawk Valley (Unmarked): add
> '''KANIEN’KEHÀ:KA'''
* Kanien’kehà:ka: add
* Kanièn:keh Nation Territory: Mohawk Valley, United States of America.
* Kanen’tó:kon: add
* First Civilization Storehouse: (See Also: Isu Vault: Grand Temple)
> '''GREAT PIECE HILLS'''
* Boston Light: add
> '''JOHN'S TOWN'''
* John's Town: add
...
* Dunwic (Dunwich): Grayfrairs Priory
* Black Bourn River
* Stour River
* Sutton Hoo
